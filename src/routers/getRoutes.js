...
appMethods.get('/Cita', validarPermisos,limitGet(), getAllMedicalAppointment);
...
appMethods.post('/Usuario', validarPermisos, limitGet(), postNewUser);
